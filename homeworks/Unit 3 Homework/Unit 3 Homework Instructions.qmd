...
You are a Springfield, Massachusetts area used car salesperson (denoted in the dataset by the region `western massachusetts`) and have been tasked by your boss to write a report on the state of the local used care market. You will also be tasked to consider whether the used car market is in any way unique compared to the rest of the country and compared to the nearby city of Boston. To help analyze this question, your boss provides you with a database of all cars listed on a popular used car website, Craigslist, during the year 2021. You can consider this total database to provide accurate population estimates.
...
According to a [recent study](), the percentage of cars sold nationally that are standard cars (not SUVs, pickups, vans, or minivans) has been declining for some time and now stands at x%
...
According to another recent study, the average odometer reading in the US is about xx,xxx.
...
Now we consider the average age of cars sold in Springfield. A recent study found that the average age of cars in the US is about 6.47 years.
