...
## Lab 2.1: Regression interpretation (Wednesday, April 5)

* Lab files: 
  + Make sure to extract (unzip) the lab files before attempting to modify them!

## Lecture 2.3: Regression Wisdom (Thursday, April 6)
...
## Lecture 4.2: Returning to regression (Tuesday, May 2)
...
## Lab 4.1: Model building part 2 (Wednesday, May 3rd)

* Lab files:

## Lecture 4.3: Interpretation activity (Thursday, May 4)
