...
> Note that student drinking is measured on a 1-5 scale. You can make a two-category version by using the `mutate` verb and `if_else()` as seen [here](https://statisticsglobe.com/r-if_else-function-dplyr-package)
...
6.	What, in your opinion, would be a substantively significant difference from these means/proportions? Make some notes about this.
